...
...so that your JHipster application use the content of this archive as `ng-jhipster` dependency which is located in `node_modules/ng-jhipster`.# videon-jhipster
